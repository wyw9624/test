...
!function ($) {
    ...
    Password.prototype.init = function() {
        ...
        this.$text = $('<input type="text" id="txtShowPwd"/>')
        ...
        this.$icon = $([
            '<span tabindex="100"  class="pa eyes-box">',
            '<i class="close-eyes' + (this.options.white ? ' icon-white' : '') +
                ' pa eyes"></i>',
            '</span>'
    ...
    Password.prototype.show = function(_relatedTarget) {
        ...
        this.$text.show();
        this.$icon.find('i')
            .removeClass('eyes close-eyes')
            .addClass('eyes open-eyes');
    ...
    Password.prototype.hide = function(_relatedTarget) {
        ...
        this.$text.hide();
        this.$icon.find('i')
            .removeClass('eyes open-eyes')
            .addClass('eyes close-eyes');
